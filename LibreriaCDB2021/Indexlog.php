...
<script>
	alert("Inicia Sesión para comprar nuestros productos, o registrate!");
	</script>
</head>
<body>
<header>
    ...
    <nav class="menu" id="up">
        ...
        <li><span class="icon-cart"></span><a href="indexlog.php">Productos</a></li>
        <li><span class="icon-user"></span><a href="indexlog.php">Usuario</a></li> 
        </ul>
    </nav>
</header>
<div class="container">
